...
export const Reward = connect(
  mapStateToProps
)(
  class Reward extends React.Component<RewardProps, RewardState> {
    ...
    render() {
      ...
      const userOwns = this.props.userRewards && Object.keys(this.props.userRewards).includes(reward._key)
      ...
      return (
        <div className="text-center">
          <img
            src={userOwns ? "/assets/images/trophy-filled.svg" : "/assets/images/trophy-empty.svg"}
            width="200px"
            height="200px"
            className="m-2"
          />

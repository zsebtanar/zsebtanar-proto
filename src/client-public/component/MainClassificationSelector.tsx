...
interface MainClassificationSelectorProps {
  classification: any
}
...
export const MainClassificationSelector = connect(mapStateToProps)(
  class MCS extends React.PureComponent<MainClassificationSelectorProps> {
    render() {

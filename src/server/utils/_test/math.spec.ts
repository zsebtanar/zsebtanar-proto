import { fractionNum, INVALID_FRACTION_NUMBER, isValid, simplifyFractionNumber } from '../math'
    ...
    describe('simplifyFractionNumber', () => {
      it('should simplify the fraction number parameter', () => {
        const values = [
          ...
          [{ numerator: 10, denominator: 10 }, { numerator: 1, denominator: 1 }],
          [{ numerator: 15, denominator: 9 }, { numerator: 5, denominator: 3 }],
          [{ numerator: 9, denominator: 15 }, { numerator: 3, denominator: 5 }],

...
export const Workarounds = connect(
  undefined,
  { openFeedbackModal }
)(function WorkaroundsPage(props) {
  return (
    <div className="col-10 mx-auto">
      ...
      <p>
        ...
        <ul>
          <li>
            Írj <Link onAction={props.openFeedbackModal}>Visszajelzés</Link> vagy
          </li>
          <li>Hozz létre egy hibajegyet a <a href="https://github.com/zsebtanar/zsebtanar-proto/issues" target="_blank" rel="noopener noreferrer">fejlesztői oldalon</a></li>
        </ul>
      </p>
      ...
      <section>
        ...
        <div className="pl-5">
          ...
          <p>
            ...
            <ol>
              <li>
                nyisd meg a következő oldalt Firefox-ban <a href="https://testpilot.firefox.com/experiments/containers" target="_blank" rel="noopener noreferrer">https://testpilot.firefox.com/experiments/containers</a>
              </li>
              <li>
                Kattints az alábbi gombra:<br />
                <img className="img-thumbnail" src="/assets/images/hibaelharitas-ff-01.png" alt="Container kikapcsolás" />
              </li>
              <li>
          ...
          <p>
            ...
            verzióját ami az alábbi linkről érhető el: <a href="https://addons.mozilla.org/en-US/firefox/addon/multi-account-containers/" target="_blank" rel="noopener noreferrer">https://addons.mozilla.org/en-US/firefox/addon/multi-account-containers/</a>
          </p>
          <p>

...
export const About = setupPage()(function AboutPage() {
  return (
      ...
      <div className="container">
        ...
        <div className="row mb-5">
          <div className="col-md">
            ...
            <p>
              A Zsebtanár egy interaktív feladatgyűjtemény, amely ingyenes és hatékony segítséget
              nyújt a tanulásban.
            </p>
          </div>
          <div className="col-md">
          ...
          <div className="col-md mb-10">
            ...
            <p>A honlapot a Zsebtanár Nonprofit Alapítvány fejleszti önkéntesek segítségével.</p>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-md">
            <img className="about-pic" width="90%" src="/assets/images/zst_gergo.jpg" alt="Gergő" />
            <h4 className="mt-4">Az Elnök</h4>
            <p>
              Gergő vagyok, dizájner. A Zsebtanár Alapítvány elnökeként elsősorban a hivatalos
              teendőket intézem. Emellett szívesen besegítek a dizájnban és a UX-fejlesztésben is.
            </p>
          </div>
          <div className="col-md">
            ...
            <p>
              ...
              hozzájárulni az oktatás javulásához. Ha ismersz valakit, aki szívesen csatlakozna,
              csak szólj! ;)
            </p>
          </div>
          <div className="col-md">
            ...
            <p>
              Viktor vagyok, matematikusként végeztem. Régi álmom egy olyan honlap, ami segít abban,
              hogy a tanulás ne nyűg, hanem játék legyen. Remélem, Te is hasznosnak találod majd. :)
            </p>
          </div>
        </div>
        <p>
          ...és még sokan mások, akik különböző módon járultak hozzá ennek a projektnek a
          megvalósulásához. Ezúton is köszönjük a segítségüket!
        </p>
        <h2 className="mb-4 mt-5">Támogatás</h2>
        <hr />
        <p>
          Ez a honlap teljes mértékben önkéntesek munkája. Ha szeretnél anyagilag támogatni
          bennünket, megteheted banki átutalással:
        </p>

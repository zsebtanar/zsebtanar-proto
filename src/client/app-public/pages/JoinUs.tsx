  ...
  return (
    <Page className="search-page">
      <div className="col-10 mx-auto">
        ...
        <p>
          Ha tudsz programozni, és szeretnél a színfalak mögé kukkantani, nézd meg a
          github-repónkat:
          <ExternalLink href="https://github.com/zsebtanar/zsebtanar-proto/">
            https://github.com/zsebtanar/zsebtanar-proto/
          </ExternalLink>{' '}
          vagy írj egy emailt az info@zsebtanar.hu-ra.
        </p>
        <p>
